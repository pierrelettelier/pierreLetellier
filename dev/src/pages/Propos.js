...
const Propos = () => {
  ...
  if (!proposData) return <div>Chargement...</div>;
  ...
  return (
    <div className="about-container">
      ...
      <section className="main-section">
        <div className='title'>
          <h1>{proposData.title}</h1>
          <h2>{proposData.sousTitre}</h2>
        </div>

        <p>{proposData.description}</p>
        <Link to="/contact">
      ...
      <section className="block13">
        <div className='contain'>
          <h2>{proposData.block13?.title}</h2>
          <div className='main'>
      ...
      <section className="block14">
        <h2>{proposData.block14?.title}</h2>
      ...
      <div className='contain'>
        <div className='left'>
         <h2>{proposData.blockBtn?.title}</h2>
        <h3>{proposData.blockBtn?.subtitle}</h3>
         <p>{proposData.blockBtn?.description}</p>
        </div>
